 ...
 * an array containing the cron jobs scheduled for the given rooms,
 * and visible to the given user.
 */
function getScheduledCronJobs(jobsInMemory, rooms, userIdForDMs = null) {
  const cronJobs = []
 ...
 * Given an object containing scheduled jobs currently in memory, an array of
 * room ids, and optionally a usedId, returns:
 * an array containing the datetime jobs scheduled for the given rooms,
 * and visible to the given user.
 */
function getScheduledDatetimeJobs(jobsInMemory, rooms, userIdForDMs = null) {
  let dateJobs = []
